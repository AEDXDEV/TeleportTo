...
class TpToCommand extends BaseCommand {
  ...
  public function prepare(): void{
    ...
    }, "teleportto.get", false);
    
    $this->registerSubCommand("remove", [new IntegerArgument("id")], function(CommandSender $sender, string $aliasUsed, array $args): void{
